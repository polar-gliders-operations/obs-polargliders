...
if os.path.isfile('/home/isgiddy/share/www/data/SB2326D.csv') == False:
        ...
        if isinstance(response, tuple):
            ...
            if From == 'data@sailbuoy.no':
                ...
                if i == 1: # Save the first instant to have a starting point
                    df.to_csv('/home/isgiddy/share/www/data/SB2326D.csv')
                
                else:
                    df.to_csv('/home/isgiddy/share/www/data/SB2326D_latest.csv')
                    
                    latest = pd.read_csv('/home/isgiddy/share/www/data/SB2326D_latest.csv')
                    full = pd.read_csv('/home/isgiddy/share/www/data/SB2326D.csv')
                    ...
                    if latest.iloc[-1].Time not in full.Time.values:
                        ...
                        full.to_csv('/home/isgiddy/share/www/data/SB2326D.csv')
                    else:
                        continue
