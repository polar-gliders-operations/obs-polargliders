...
wget -P /home/isgiddy/share/www/data/adt ftp://mduplessis2:JurgenKlopp10*@nrt.cmems-du.eu/Core/SEALEVEL_GLO_PHY_L4_NRT_OBSERVATIONS_008_046/dataset-duacs-nrt-global-merged-allsat-phy-l4/${yr}/${mnth}/nrt_global_allsat_phy_l4_${ymd}_${ymd}.nc
