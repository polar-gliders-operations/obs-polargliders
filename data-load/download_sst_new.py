...
server_path = '/home/mduplessis/share/www/data/'

catalog_url = "https://www.ncei.noaa.gov/thredds-ocean/catalog/ghrsst/L4/GLOB/JPL/MUR/2023/074/catalog.xml"

# Spatial and temporal subset (example: bounding box around North Sea)
west, east, south, north = 10.0, 30.0, -45.0, -30.0
time_sel = None  # e.g. "2023-03-15T09:00:00Z" or None to get whole file (careful, may be large)

os.makedirs(server_path, exist_ok=True)

cat = TDSCatalog(catalog_url)
print("Catalog title:", cat.title)
...
# query.lonlat_box(north=-50, south=-70, east=15, west=-15) # choose lat and lon boundaries
...
# sst.to_netcdf(server_path + 'sst/sst_{}.nc'.format((sst.time.dt.strftime("%Y%m%d")).values.tolist()[0]))
